...
public class ArrayListDatabaseManager {
    ...
    public ArrayListDatabaseManager() {
        if (!unterkuenfteLoaded) {
            ...
            addUnterkunft(new Unterkunft("Vollpension", 40, "Viele umweltfreundliche Details und ein Fahrradverleih in der Unterkunft erwarten Sie in diesem Hotel in Berlin. Das Landmark Eco Hotel befindet sich nur 5 Gehminuten von der beliebten Einkaufsmeile Kurfürstendamm entfernt. WLAN nutzen Sie kostenfrei. Alle komfortablen energieeffizienten Zimmer im Hotel verfügen über ausgewählte Bettwäsche, Kabel-TV und ein eigenes Bad mit einem Haartrockner und zwei Becherhaltern.", 4, "Landmark Eco Hotel", "Berlin", "Hotel"));
